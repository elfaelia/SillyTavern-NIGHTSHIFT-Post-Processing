...
export class PipelineBar {
    ...
    init(stopCallback) {
        this.progressBar = $("#nightshift_progress_bar");
        this.progressText = $("#nightshift_progress_text");
        this.progressFill = $("#nightshift_progress_fill");
        this.formShield = $("#form_sheld");

        this.progressBar.find("#nightshift_stop_pipeline").on("click", () => {
            this.hide();
    ...
    start(totalPasses, initialText) {
        ...
        this.formShield.addClass("nightshift-input-active");
    }
    ...
    hide() {
        ...
        this.formShield.removeClass("nightshift-input-active");
    }
}
